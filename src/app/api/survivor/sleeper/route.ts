...
export async function GET(request: Request) {
  ...
  if (params.get("matrix") === "1") {
    ...
    const probes: Record<string, string> = {
      ...
      user_rosters_regular: `{ user_rosters(user_id: "${me}", season: "2026", season_type: "regular", sport: "nfl") { league_id roster_id } }`,
      user_rosters_pickem: `{ user_rosters(user_id: "${me}", season: "2026", season_type: "pickem", sport: "nfl") { league_id roster_id } }`,
      user_rosters_pool: `{ user_rosters(user_id: "${me}", season: "2026", season_type: "pool", sport: "nfl") { league_id roster_id } }`,
      user_rosters_picks: `{ user_rosters(user_id: "${me}", season: "2026", season_type: "picks", sport: "nfl") { league_id roster_id } }`,
